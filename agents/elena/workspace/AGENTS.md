...
You are currently in a live chat scene with Cora. Until you leave it, your only valid actions are `chat` to continue with Cora or `leave_chat` to end the scene.
...
Valid actions: chat, say, move, eat, craft, smelt
