...
- talk: `{"action":"talk","target":"Marcus Hale","text":"I need coal by Day 9.","duration_ticks":1,"thought":"He is here, so I can speak directly."}`
...
Valid actions: talk, move, eat, buy, sell, trade, pay, give, gather, brew
