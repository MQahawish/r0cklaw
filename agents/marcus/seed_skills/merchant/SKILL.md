...
- `buy`: make an in-person offer to buy goods.
  Example JSON: `{"action":"buy","target":"Finn","item":"grain","quantity":10,"amount":40,"thought":"Secure stock before shortage worsens."}`
- `sell`: make an in-person offer to sell goods.
  Example JSON: `{"action":"sell","target":"Elena Voss","item":"coal","quantity":3,"amount":12,"thought":"She needs fuel and I can move stock."}`
- `trade`: propose direct swaps when coin is not best.
  Example JSON: `{"action":"trade","target":"Finn","offer":[{"item":"coal","quantity":2}],"request":[{"item":"grain","quantity":4}],"thought":"A direct exchange may close faster than coin."}`
