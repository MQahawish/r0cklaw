...
leave_message.sh <agent> "<message>"
  ...
  Example: leave_message.sh marcus "Marcus, a traveller asked about grain prices. Worth discussing. -- Sera"


## Innkeeper skills

serve.sh <agent> <item>
  Provide food or drink. Builds goodwill.
  Example: serve.sh rook ale

rent_room.sh <agent> <nights>
  Let a room to someone for lodging.
  Example: rent_room.sh marcus 2

eavesdrop.sh
  Listen carefully to conversations in the inn.
  Costs nothing but time. Results go into HEARTBEAT.

post_notice.sh "<message>"
  Pin a public notice in the inn for all visitors to read.
  Example: post_notice.sh "Harvest festival: bring what you can spare"
