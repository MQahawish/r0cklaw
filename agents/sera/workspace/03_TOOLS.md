...
`serve`
  ...
  Example JSON: use the `serve` action with the typed fields for this verb.

`rent_room`
  Let a room to someone for lodging.
  Example JSON: use the `rent_room` action with the typed fields for this verb.
...
`post_notice`
  ...
  Example JSON: use the `post_notice` action with the typed fields for this verb.
