...
leave_message.sh <agent> "<message>"
  ...
  Example: leave_message.sh marcus "Marcus, I have 10 grain ready. Come by the farm when you can. -- Finn"


## Farmer skills

harvest.sh <crop> <quantity>
  Bring in crops from the field. Must be at farm.
  Example: harvest.sh grain 8

plant.sh <crop> <quantity>
  Sow seeds for the next season. Must be at farm.
  Example: plant.sh grain 5

water.sh <field>
  Tend the irrigation. Improves next harvest quality.
  Example: water.sh north_field
